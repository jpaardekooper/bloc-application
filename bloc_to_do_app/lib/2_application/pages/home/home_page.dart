...
import 'package:bloc_to_do_app/2_application/pages/home/bloc/navigation_todo_cubit.dart';
              ...
              config: <Breakpoint, SlotLayoutConfig>{
                Breakpoints.mediumAndUp: SlotLayout.from(
                  ...
                  builder: (context) => AdaptiveScaffold.standardNavigationRail(
                    leading: IconButton(
                      key: const Key('create-login'),
                      onPressed: () async {
                        await context.pushNamed(SignInScreen.pageConfig.name).then(
                          (value) {
                            if (value == true) {
                              debugPrint('logged in was succesfully');
                            }

                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text('logged in was succesfullyy'),
                      ...
                      icon: Icon(SignInScreen.pageConfig.icon),
                      tooltip: 'Login',
                    ),
                    trailing: IconButton(
